...
TEST {
    ...
    },
    {
        ...
        content = [[
            ...
            local l = linq.list(2, 3, 4, 5):enumerate()
            local <?fork?> = l:fork(function (e)
                if e:any() then return nil end
                return 1
            end, function (e)
                return e
            end)
    ...
    hover = [[
```lua
local fork: enumerable<integer|enumerable<integer>>
```]],
}
